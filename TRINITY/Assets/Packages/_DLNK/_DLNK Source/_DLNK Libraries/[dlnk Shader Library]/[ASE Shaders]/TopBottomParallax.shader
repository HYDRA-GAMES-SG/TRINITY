	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 OffsetPOM149 = POM( _ParallaxMap, texCoord151, ddx(texCoord151), ddy(texCoord151), WorldNormal, ase_viewDirWS, ase_viewDirTS, (int)_Samplesxy.x, (int)_Samplesxy.y, 2, _Parallax, _Curvature.x, _ParallaxMap_ST.xy, float2(0,0), 0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float2 OffsetPOM149 = POM( _ParallaxMap, texCoord151, ddx(texCoord151), ddy(texCoord151), ase_worldNormal, ase_viewDirWS, ase_viewDirTS, (int)_Samplesxy.x, (int)_Samplesxy.y, 2, _Parallax, _Curvature.x, _ParallaxMap_ST.xy, float2(0,0), 0 );
				float2 customUVs148 = OffsetPOM149;
				float2 temp_output_147_0 = ddx( texCoord151 );
				float2 temp_output_146_0 = ddy( texCoord151 );
				float4 tex2DNode2 = tex2D( _MainTex, customUVs148, temp_output_147_0, temp_output_146_0 );
...
Node;AmplifyShaderEditor.SamplerNode;7;-666.1178,732.2252;Inherit;True;Property;_MetalnessTop;MetalnessTop;29;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;3;-848,-336;Inherit;True;Property;_AlbedoTop;AlbedoTop;26;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;5;-960,432;Inherit;True;Property;_BumpMapTop;BumpMapTop;27;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=82AE8872A234501CCCEAB80394A67E51F3FB9859