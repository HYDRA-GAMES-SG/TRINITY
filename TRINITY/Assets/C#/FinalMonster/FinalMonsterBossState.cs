...
public class FinalMonsterBossState : MonoBehaviour, IState
{
    protected AFinalMonsterBossFSM FinalMonsterBossFSM;
    ...
    public virtual void SetStateMachine(AFinalMonsterBossFSM finalMonsterBossFSM)
    {
        FinalMonsterBossFSM = finalMonsterBossFSM;
    }
}
