...
public class PenguinBossState : MonoBehaviour, IState
{
    protected APenguinBossFSM PenguinBossFSM;
    ...
    public virtual void SetStateMachine(APenguinBossFSM penguinBossFSM)
    {
        PenguinBossFSM = penguinBossFSM;
    }
}
